...
importMiniui(function () {
    require(["plugin/webuploader/webuploader.min", "message", "request", "jquery", "miniui-tools"], function (WebUploader, message, request, jquery, tools) {
        ...
        uploader.on('uploadSuccess', function (file, resultData) {
            if (resultData && resultData.status == 200 && resultData.result) {
                returnData.push(resultData.result);
                parent.uploadFileUrls.push(resultData.result);
            }
        });
